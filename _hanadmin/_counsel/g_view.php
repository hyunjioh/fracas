...
<table width="100%" cellspacing="0" cellpadding="0" class="viewtable">
	...
	<tr>
		...
		<td colspan="2" class="tabletd"><?=$Value[Category]?></td>
	</tr>
	<tr>
	...
	<tr>
		<th class="tableth">핸드폰번호</th>
		<td colspan="2" class="tabletd"><?=$Value[UserTel]?></td>
	</tr>
	<tr>
		<th class="tableth">이메일</th>
		<td colspan="2" class="tabletd"><?=$Value[UserEmail]?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2" class="tabletdcontent smartOutput" height="100">
		<?=AttachThumbNail($Value['idx'],$Board['thumb_b_size']); ?>		
		<?=$Value[Content]?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2" class="tabletd"><?=$Value[Status]?></td>
	</tr>
	<tfoot>
		<tr>
		<td colspan="3" class="tfoottd_R">
		<a href="<?=$href?>"><img src="<?=_ADMIN_?>/images/board/btn_list.gif" align="middle"></a> 
		<!--<a href="<?=$href?>&at=reply&idx=<?=$Value[idx]?>"><img src="<?=_ADMIN_?>/images/board/btn_reply.gif" align="middle"></a>-->
