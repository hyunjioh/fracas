...
<table width="100%" cellspacing="0" cellpadding="0" class="viewtable">
	...
	<tr>
		...
		<td colspan="2" class="tabletd"><?=$Value[StartTime]?> ~ <?=$Value[EndTime]?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tabletd right number">Date : <?=substr($Value[RegDate],0,10)?></td>
	</tr>
	<tr>
		<th class="tableth">내용</th>
		<td colspan="2" class="tabletdcontent smartOutput" height="200">
		<?=$Value[Content]?></td>
	</tr>
	<tfoot>
		<tr>
