<?php
  ...
  /*-------------------------------------------------------------------------------------------------
	...
	/*-------------------------------------------------------------------------------------------------
	▶ 게시판 정보 */	
	$Board['board_id'] = "popup";
	$Board['board_name'] = "팝업창관리";
	$Board['table_board'] = "G_Popup";
	$Board['table_attach'] = "";
	$Board['page_limit'] = 10;
	$Board['page_block'] = 10;
	$Board['use_file'] = 10;
	...
	switch($req['at']){
		case "view": 
			$include_page = "popup_view.php"; break;
		case "write": 
		case "modify": 
		case "reply": 
			$include_page = "popup_form.php"; break;
		case "dataprocess": 
			$include_page = "popup_action.php"; break;
		case "download": 
			download();		break;
		default:
			$include_page = "popup_list.php"; break;
	}
