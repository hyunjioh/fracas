...
<table width="100%" cellspacing="0" cellpadding="0" class="formtable">
	...
	<tr>
		...
		<td class="tabletd"><input type="checkbox" name="Notice"  value="Y"  <?=Checked("Y",$Value[Notice])?> class="input-checkbox"> 공지</td>
	</tr>
	<tr>
		...
		<td class="tabletd">
			...
			<div style="background-color:#f5f5f5; border:1px dotted #ff6600; padding:10px; margin-bottom:5px">
				...
				* 첨부파일은 <b><?=str_replace("|",",",$Board['file_check_ext'])?></b> <?=($Board['file_check_type']=="deny")? "를 제외한 파일이 업로드 가능합니다.":" 만 가능합니다."; ?> <br>
				&nbsp;&nbsp;<span style="cursor:pointer" onClick="javascript:addFileField('<input type=file name=files[] class=input-blur size=50>')"><img src='<?=_ADMIN_?>/images/icon_plus.png' alt='plus' align='middle' /></span> <span style="cursor:pointer" onClick="javascript:removeFileField()"><img src='<?=_ADMIN_?>/images/icon_minus.png' alt='minus' align='middle' /></span>
			</div>
			<?
