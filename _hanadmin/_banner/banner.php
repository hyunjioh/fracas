...
switch($req['at']){
  case "view": 
    $include_page = "banner_view.php"; break;
  case "write": 
  case "modify": 
  case "reply": 
    $include_page = "banner_form.php"; break;
  case "dataprocess": 
    $include_page = "banner_action.php"; break;
  case "download": 
    download();		break;
  default:
    $include_page = "banner_list.php"; break;
}
