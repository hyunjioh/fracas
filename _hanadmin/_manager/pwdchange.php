<?php
	...
	/*-------------------------------------------------------------------------------------------------
	▶ 게시판 정보 */	
	$Board['board_id'] = "Z00113";
	$Board['board_name'] = "관리자비밀번호변경";
	$Board['table_board'] = "G_Manager";
	$Board['table_attach'] = "";
	$Board['page_limit'] = 10;
	$Board['page_block'] = 10;
	$Board['use_file'] = 10;
	...
	switch($req['at']){
		case "dataprocess": 
			$include_page = "pwdchange_action.php"; break;
		default:
			$include_page = "pwdchange_form.php"; break;
	}
