...
/*-------------------------------------------------------------------------------------------------
▶ 게시판 정보 */
$Board['board_id'] = "course02";
$Board['board_name'] = "데모강좌보기";
//$Board['table_board'] = "G_Info";
$Board['table_board'] = "G_Info_Comment";
...
switch($req['at']){
  case "view": 
    $include_page = "class_view.php"; break;
  case "dataprocess": 
    $include_page = "class_action.php"; break;
  case "download": 
    download();		break;
      case "write": 
      case "modify": 
      case "reply": 
        $include_page = "class_form.php"; break;
  default:
    $include_page = "class_list.php"; break;
}
